...
<html lang="tw">
    <head>
        <title>鴻蘴 - EGGER型錄 - 超寬版系列</title>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta name="Description" content="鴻蘴超耐磨地板型錄 鴻蘴型錄 超耐磨地板型錄 EGGER超耐磨地板 EGGER木地板 超寬版系列">
        <meta name="keywords" content="鴻蘴超耐磨地板 鴻蘴型錄 鴻蘴木地板 EGGER超耐磨地板 EGGER-超寬版系列">
        <meta property="og:description" content="鴻蘴超耐磨地板型錄 鴻蘴型錄 超耐磨地板型錄 EGGER超耐磨地板 EGGER木地板 超寬版系列">
        <meta property="og:title" content="鴻蘴 - EGGER型錄 - 超寬版系列">
        <meta property="og:site_name" content="鴻蘴 - EGGER型錄 - 超寬版系列">
        <link rel="canonical" href="https://www.hongfeng.com.tw/menu/超寬版系列">
        <meta property="og:url" content="https://www.hongfeng.com.tw/menu/超寬版系列">
    ...
    <body>
            ...
            <nav class="nav bd-container">
                ...
                <div class="nav__menu" id="nav-menu">
                    <ul class="nav__list">
                        ...
                        <li class="nav__item"><a href="https://www.hongfeng.com.tw/menu/超寬版系列" class="nav__link active-link">超寬版系列</a></li>
                    </ul>
                </div>
        ...
        <main class="l-main">
            ...
            <?php
                ...
                echo '<section class="menu section bd-container" id="超寬版系列" style="min-height:100vh; height:100%; margin-bottom:3em">';
                echo '<span class="section-subtitle" data-aos="zoom-in" data-aos-duration="500">EGGER 超耐磨地板</span>';
                echo '<h1 class="section-title" data-aos="zoom-in" data-aos-duration="700">超寬版系列</h1>';
                echo '<div class="menu__container bd-grid">';
				$AOS_duration = 700;
				if($type){
					$jpgs = glob("../../assets/img/floor/超寬版系列/color_card/*.webp");
				}else{
					$jpgs = glob("../../assets/img/floor/超寬版系列/color_card/*.jpg");
				}
				foreach ($jpgs as $jpg) {
					$layout='<div class="menu__content" data-aos="zoom-out" data-aos-duration="'.$AOS_duration.'">';
					$layout.='<img src="'.$jpg.'" alt="鴻蘴_EGGER-超寬版系列" class="menu__img">';
					...
					$layout.='<span class="menu__preci" style="padding:0 0 10px 15px;">超寬版系列</span>';
					$layout.='<a class="button menu__button" onclick="getPic(\'series=超寬版系列&color='.$str_serie[0].'\')"><i class="bx">了解更多</i></a>';
